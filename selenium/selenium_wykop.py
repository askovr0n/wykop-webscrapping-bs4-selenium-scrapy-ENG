...
SET_PAGES_TO_SCRAPE_PER_ONE_LOOP = 5 # 35 IS MAX
...
for idx_subpage in range(1, adjust_loop()+1):
    ...
    for idx_article in range(1, check_pages(SET_PAGES_TO_SCRAPE_PER_ONE_LOOP)+1):
        ...
        try:
            check_adv = f'/html/body/div[2]/div[2]/div[2]/div/ul[2]/li[{idx_article}]/div/div[1]/a/span[1]'
